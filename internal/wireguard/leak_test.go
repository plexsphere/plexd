...
func TestMain(m *testing.M) {
	...
	// Windows. That is the real-adapter test alone: everything else swaps in a
	// loopback listener. The exemption names that one function, so a goroutine
	// this package actually leaks still fails the run.
	//
