...
- [Bare-Metal Packaging Reference](../reference/deployment/bare-metal-packaging.md) — Full reference for InstallConfig, unit file directives, and install script flags.
